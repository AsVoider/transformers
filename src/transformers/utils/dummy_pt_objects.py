...
class BambooForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class BambooForSequenceClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class BambooModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class BambooPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
